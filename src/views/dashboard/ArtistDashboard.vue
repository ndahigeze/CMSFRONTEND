                ...
                <div class="row">
                   ...
                   <div class="col-md-8">
                       <div class="text-center mt-2" >
                           <div class="shadow" data-category="pending" style="padding:20px;height:50vh" >
                             <div class="row">
                                 <div class="col-md-6 mt-5">
                                       <stats-card title="PUBLISHED"
                                 ...
                                 <div class="col-md-6 mt-5">
                                    <stats-card title="UNPUBLISHED"
                                                    type="gradient-orange"
                                                    :sub-title="unpublished"
                                                    icon="ni ni-chart-pie-35"
                                                    class="mb-4 mb-xl-0"
                                        >
